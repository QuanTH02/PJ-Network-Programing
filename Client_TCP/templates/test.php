    ...
    <div class="sidebar">
        <div class="row mr-0">
            ...
            <div class="col-10">
                ...
                <div class="list-folder" id="id-list-folder">
                    ...
                    <table style="width: 91.8%; margin-left: 3.8%;">
                        ...
                        <tr class="tr-folder-list">
                            <!-- If file <i class="fa-regular fa-file"></i> -->
                            <td class="table-img-folder"><i class="fa-regular fa-folder"></i></td>
                            <td class="table-name-folder">Main folder</td>
                            ...
                            <td class="table-modified-by">Username</td>
                        ...
                        <tr class="tr-folder-list">
                            ...
                            <td class="table-name-folder">Main text</td>
                            <td class="table-copy-move-download">
                                <button class="folder-copy"><i class="fa-regular fa-copy"></i></button>
                                <button class="folder-download"><i class="fa-solid fa-download"></i></button>
                                <button class="folder-move"><img src="img/move-folder.svg" alt=""></button>
                ...
                <div class="list-folder" id="list-member-pending" style="height: 360px; display: none;">
                    <!-- Member -->
                    <div id="members" style="display: block;">
                        <table style="width: 91.8%; margin-left: 3.8%;">
                            ...
                            <tr>
                                <td class="table-img-folder"></td>
                                <td class="table-name-member" style="font-size: 12px;">Name <button class="icon-down"><i
                                            class="fa-solid fa-chevron-down"></i></button></td>
                                <td class="table-role" style="font-size: 12px;">Role <button class="icon-down"><i
                                            class="fa-solid fa-chevron-down"></i></button></td>
                                <td class="table-remove-member"></td>
                            </tr>

                            <!-- Content -->
                            <tr class="tr-folder-list">
                                <td class="table-img-folder"><img src="img/vebinh1.jpg" alt="Img"></td>
                                <td class="table-name-member">Username (you)</td>
                                <td class="table-role">Owner</td>
                                <td class="table-remove-member"><button class="icon-remove-member"><i
                                            class="fa-solid fa-user-minus"></i></button></td>
                            </tr>
                            <tr class="tr-folder-list">
                                <td class="table-img-folder"><img src="img/vebinh1.jpg" alt="Img"></td>
                                <td class="table-name-member">Username</td>
                                <td class="table-role">Member</td>
                                <td class="table-remove-member"><button class="icon-remove-member"><i
                                            class="fa-solid fa-user-minus"></i></button></td>
                            </tr>
                            <tr class="tr-folder-list">
                    ...
                    <div id="pending-requests" style="display: none; height: 360px;">
                        <table style="width: 91.8%; margin-left: 3.8%;">
                            ...
                            <tr class="tr-folder-list">
                                ...
                                <td class="table-decline"><button class="icon-table-decline"><i
                                            class="fa-solid fa-xmark" style="opacity: 1;"></i></button></td>
                            </tr>
                            <tr class="tr-folder-list">
                                <td class="table-img-folder"><img src="img/vebinh1.jpg" alt="Img"></td>
                                <td class="table-name-member-invite">Username</td>
